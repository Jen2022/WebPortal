...
from .models import Sport, Team, TeamCategory, Workspace, ParentPlayer, SessionImpact,SessionImpactsOverview
...
admin.site.register(SessionImpactsOverview)
admin.site.register(SessionImpact)
